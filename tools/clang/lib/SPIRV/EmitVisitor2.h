...
//===----------------------------------------------------------------------===//
#ifndef LLVM_CLANG_SPIRV_EMITVISITOR2_H
#define LLVM_CLANG_SPIRV_EMITVISITOR2_H
...
public:
  EmitTypeHandler2(SpirvContext &spvContext,
  ...
  EmitTypeHandler2(const EmitTypeHandler2 &) = delete;
  EmitTypeHandler2 &operator=(const EmitTypeHandler2 &) = delete;
...
/// representation.
class EmitVisitor2 : public Visitor {
public:
...
public:
  EmitVisitor2(SpirvContext &spvCtx,
              const SpirvCodeGenOptions &opts)
      : Visitor(opts, spvCtx), id(0),
        typeHandler(spvCtx, opts, &debugVariableBinary,
...
#endif // LLVM_CLANG_SPIRV_EMITVISITOR2_H
